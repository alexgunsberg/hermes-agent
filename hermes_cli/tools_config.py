...
CONFIGURABLE_TOOLSETS = [
    ...
    ("cursor",          "🖱️  Cursor Cloud Agents",      "cursor_agent (requires CURSOR_API_KEY)"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "cursor"}
