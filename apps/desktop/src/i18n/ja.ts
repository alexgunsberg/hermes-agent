...
export const ja = defineLocale({
  ...
  boot: {
    ...
    health: {
      connected: {
        title: 'ゲートウェイに接続済み',
        hint: 'デスクトップゲートウェイに到達できます。'
      },
      reconnecting: {
        title: 'ゲートウェイに再接続中',
        hint: 'Hermes がライブ接続を再試行しています。このウィンドウを開いたままにしてください。'
      },
      endpoint_unreachable: {
        title: 'ゲートウェイに到達できません',
        hint: 'このアドレスのゲートウェイに到達できません。リモート側で Hermes が動作しており、このマシンから到達できることを確認してから、再試行するかゲートウェイ設定を開いてください。'
      },
      http_ok_ws_rejected: {
        title: 'ライブ接続が拒否されました',
        hint: 'ゲートウェイは応答しましたが、ライブチャット接続が拒否されました。ゲートウェイ設定で再テストし、必要なら再サインインするか、再試行してください。'
      },
      auth_rejected: {
        title: 'ゲートウェイへのサインインが必要です',
        hint: 'ゲートウェイセッションが無効です。ゲートウェイ設定でもう一度サインインしてから再試行してください。'
      },
      unknown: {
        title: 'ゲートウェイ接続に問題があります',
        hint: 'ゲートウェイへの接続中に問題が発生しました。再試行するか、ゲートウェイ設定を開くか、ローカルゲートウェイに切り替えてください。'
      }
    },
    failure: {
